...
async function extractPdfText(pdfUrl: string): Promise<string> {
  ...
  console.log("[PDF] BSE_SERVICE_URL env var:", bseServiceUrl ? "SET" : "NOT SET")
  
  if (!bseServiceUrl) {
    console.error("[PDF] BSE_SERVICE_URL not configured - PDF extraction will fail")
    return ""
  }
  ...
  try {
    ...
    console.log("[PDF] Calling Python PDF service:", extractUrl)
